...
```json
{
  "bsGitBranch" : "main",
  "javaVersion" : "11",
  "bsGitRepository" : "github.com?owner=kzhelyazkova&repo=my-tanzu-app",
  "ide" : "intellij",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->my-tanzu-app]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=kzhelyazkova&repo=my-tanzu-app'
